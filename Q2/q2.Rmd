...
### Using Twitter API to get the followers of Ben-Gurion University account ([@bengurionu](https://twitter.com/bengurionu?lang=en))
...
# g = add.edges(g, c("RealRomaDowney", "TrumpGolf"))
# g = add.edges(g, c("JesseBWatters", "AnnCoulter"))
# tkplot(g, layout = layout.kamada.kawai)
